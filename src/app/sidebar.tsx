...
export default function SidebarLayout() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-16 left-0 h-[calc(100vh-4rem)] bg-slate-950/80 backdrop-blur-sm  border-r border-slate-800 flex flex-col justify-between transition-all duration-300 ${
          isOpen ? 'w-80' : 'w-24'
        }`}
      >
